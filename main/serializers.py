...
class ProductListSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','category',  'title', 'tag_list', "detail",  'price','image', 'date_added', 'featured_image1', 'featured_image2', 'featured_image3', 'featured_image4']         
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Products
        fields = ['id','category', 'tag_list', 'vendor', 'image', 'title', 'detail', 'price', 'product_rating', 'featured_image1', 'featured_image2', 'featured_image3', 'featured_image4']         
    def __init__(self, *args, **kwargs):
